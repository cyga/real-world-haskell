...
throwSqlErrorIO state nativeerror errormsg =
    evaluate (throwSqlError state nativeerror errormsg)-- file: ch19/dynexc.hs
...
handleSqlError action =
    ...
    where handler e = fail ("SQL error: " ++ show e)-- file: ch19/dynexc.hs
...
handleSql = flip catchSql-- file: ch19/dynexc.hs
